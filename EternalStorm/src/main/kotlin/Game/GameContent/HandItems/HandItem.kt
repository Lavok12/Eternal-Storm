    ...
    open fun physicUpdate() {
        if (block) {
            ...
            val multiplier = when (descriptor.speedType) {
                SpeedMultiplierType.Melee -> buffSystem.getStat(StatTags.MELEE_SPEED)
                SpeedMultiplierType.Ranged -> buffSystem.getStat(StatTags.RANGED_SPEED)
                SpeedMultiplierType.DiggingTile -> buffSystem.getStat(StatTags.DIGGING_TILE)
                SpeedMultiplierType.DiggingWall -> buffSystem.getStat(StatTags.DIGGING_WALL)
                SpeedMultiplierType.PlacingTile -> buffSystem.getStat(StatTags.PLACING_BLOCK)
                SpeedMultiplierType.PlacingWall -> buffSystem.getStat(StatTags.PLACING_WALL)
