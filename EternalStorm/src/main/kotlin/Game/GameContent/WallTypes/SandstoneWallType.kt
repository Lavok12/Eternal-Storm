...
class SandstoneWallType() : AbstractWallType() {
    override val tag: String = WallList.sandstone_wall
    override val blockStrength: Int = 12
    override val maxHp: Int = 12
    override val texture: String = AppState.res("sandstoneTexture.jpg")
    override val drop: DropEntry = SingleDrop(ItemsList.sandstone_wall)
