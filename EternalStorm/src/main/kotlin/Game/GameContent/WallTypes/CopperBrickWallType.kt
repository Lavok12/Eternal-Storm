...
class CopperBrickWallType() : AbstractWallType() {
    override val tag: String = WallList.copper_brick_wall
    override val blockStrength: Int = 50
    override val maxHp: Int = 40
    override val texture: String = "copper_bricks.png"
    override val drop: DropEntry = SingleDrop(ItemsList.copper_brick_wall)
